...
export const agreementTestimonials: Testimonial[] = [
  {
    ...
    location: "Bengaluru",
    text: "Got our shareholder agreement drafted in 24 hours. The advocate understood startup nuances perfectly. Highly recommended for tech companies!",
    rating: 5,
  ...
  },
  {
    ...
    role: "HR Manager",
    location: "Hyderabad",
    text: "We've standardized all our employment contracts through VakilTech. Consistent quality and quick turnarounds have made onboarding seamless.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Property Owner",
    location: "Mumbai",
    text: "Finally, rental agreements that actually protect landlords! Clear terms and professionally drafted. Worth every rupee.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Consultant",
    location: "Chennai",
    text: "As a freelance consultant, having proper contracts is crucial. VakilTech's consulting agreements are comprehensive and client-ready.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Business Owner",
    location: "Delhi",
    text: "Needed a partnership deed urgently for a new venture. VakilTech delivered same-day with all the clauses I needed. Professional service!",
    rating: 5,
