  ...
  return (
    ...
    >
      ...
      <div className="pl-4">
        ...
        {/* Payment Breakdown - 2 Step Process */}
        {showPaymentBreakdown && (
          <div className="mx-4 mb-4 rounded-lg bg-gradient-to-r from-info/10 to-primary/10 border border-info/30 p-4">
            <div className="space-y-3">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <ul className="space-y-1">
                    <li className="flex items-start gap-1.5">
                      ...
                      <span className="text-xs text-text-body">Free consultation</span>
                    </li>
                    <li className="flex items-start gap-1.5">
                      <svg
                        className="h-3.5 w-3.5 shrink-0 text-success mt-0.5"
                      ...
                      <span className="text-xs text-text-body">Legal notice drafted</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              {/* Divider */}
              <div className="border-t border-info/20"></div>
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <ul className="space-y-1">
                    <li className="flex items-start gap-1.5">
                      ...
                      <span className="text-xs text-text-body">After your approval</span>
                    </li>
                    <li className="flex items-start gap-1.5">
                      <svg
                        className="h-3.5 w-3.5 shrink-0 text-success mt-0.5"
                      ...
                      <span className="text-xs text-text-body">We send the notice</span>
                    </li>
                  </ul>
                </div>
              </div>
