...
import {
  ...
  gstDocuments,
  gstEligibility,
} from "@/components/gst-registration/gst-data";
import {
  HowWeWorkTimeline,
  TestimonialsSection,
...
export default function GSTRegistrationPage() {
  return (
    <main>
      <PageViewTracker serviceType="GST Registration" />
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-text-medium">
                  Scan copies of these for quick approval.
                </p>
              </div>
              <ul className="space-y-4">
                {gstDocuments.map((doc, idx) => (
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-text-medium">
                  Mandatory under the GST Act for these businesses.
                </p>
              </div>
              <div className="space-y-4">
                {gstEligibility.map((item, idx) => (
      ...
      <HowWeWorkTimeline
        ...
        subtitle="Get your GSTIN in 4 simple steps"
        steps={gstTimelineSteps.map((step) => ({
          title: step.title,
      ...
      <TestimonialsSection
        className="bg-white"
        testimonials={gstTestimonials.map((t) => ({
          quote: t.text,
          name: t.name,
      ...
      <FAQSection
        ...
        subtitle="Everything you need to know about GST"
        showDove={true}
      />
      ...
      <WhatsAppFloater
        ...
        message="Hi! I need help with GST Registration. Can you assist me?"
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: "Online GST Registration Service",
            description: "Online GST Registration Service in India starting at ₹698. Get your 15-digit GSTIN easily.",
            provider: {
              "@type": "Organization",
              name: "VakilTech",
