...
import {
  ...
  heroFlipWords,
  heroFeatureBadges,
} from "@/components/agreement-drafting/rental-data";
import {
  HowWeWorkTimeline,
  TestimonialsSection,
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "online rent agreement drafting",
  ],
  openGraph: {
    title: "Rental Agreement Online | Draft Rent Agreement @ ₹299",
    description: "Get your Rental Agreement drafted online. Lawyer verified. Fast delivery.",
    url: "https://vakiltech.in/agreement-drafting/rental-agreement",
    type: "website",
  },
};

/**
 * Rental Agreement Service Page
 */
export default function RentalAgreementPage() {
  return (
    <main>
      <PageViewTracker serviceType="Rental Agreement" />

      {/* Hero Section */}
      <AgreementHeroSection
        title="Rental Agreement"
        subtitle="Drafting Services"
        price={299}
        flipWords={heroFlipWords}
        featureBadges={heroFeatureBadges}
        imageSrc="/assets/our-services/rental-agreement.png"
        imageAlt="Rental Agreement Drafting"
        serviceName="Rental Agreement"
        pricingFeatures={[
            "Lawyer Drafted",
            "Custom Clauses",
            "Delivered in 24 Hrs",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: "https://vakiltech.in/agreement-drafting/rental-agreement",
              },
            ],
          }),
        }}
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-text-medium">
                  We need these details to draft the agreement.
                </p>
              </div>
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-text-medium">
                  Suitable for various rental scenarios.
                </p>
              </div>
              <div className="space-y-4">
                {rentalEligibility.map((item, idx) => (
      ...
      <HowWeWorkTimeline
        ...
        subtitle="Get your agreement in 4 simple steps"
        steps={rentalTimelineSteps.map((step) => ({
          title: step.title,
      ...
      <TestimonialsSection
        className="bg-white"
        testimonials={rentalTestimonials.map((t) => ({
          quote: t.text,
          name: t.name,
      ...
      <FAQSection
        ...
        subtitle="Everything about Rental Agreements"
        showDove={true}
      />
      ...
      <WhatsAppFloater
        ...
        message="Hi! I need a Rental Agreement drafted. Can you help?"
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Service",
            name: "Rental Agreement Drafting Service",
            description: "Online Rental Agreement Drafting Service in India starting at ₹299. Lawyer verified drafts.",
            provider: {
              "@type": "Organization",
              name: "VakilTech",
